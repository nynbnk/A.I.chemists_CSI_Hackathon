...
param chatGptDeploymentCapacity int = 30  //10
param chatGptModelName string = (openAiHost == 'azure') ? 'gpt-35-turbo' : 'gpt-3.5-turbo' //gpt-35-turbo
param chatGptModelVersion string = '0613'  //'1106-preview'
