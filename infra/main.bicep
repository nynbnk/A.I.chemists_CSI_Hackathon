...
param chatGptDeploymentCapacity int = 10  //30
param chatGptModelName string = (openAiHost == 'azure') ? 'gpt-4' : 'gpt-4' //gpt-35-turbo
param chatGptModelVersion string = '1106-Preview'  //'0613'
