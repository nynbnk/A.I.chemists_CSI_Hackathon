                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img
                                src="https://raw.githubusercontent.com/nynbnk/A.I.chemists_CSI_Hackathon/eb32a4cf99b885babe575355696bbd05ac32de6c/app/frontend/src/assets/uwm_csi_logo.png"
                                alt="Chat logo"
                                width="500"
                            />
